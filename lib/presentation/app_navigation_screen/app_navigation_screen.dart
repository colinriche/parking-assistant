...
import '../../welcome_pop_up_dialog/welcome_pop_up_dialog.dart';
...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapWelcomepopup(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => AlertDialog(
          content: WelcomePopUpDialog(),
  ...
  onTapTimer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.timerScreen);
  }
  ...
  onTapPreviousparking(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.previousParkingScreen);
  }
